...
public class QRCode {
    ...
    /// <summary>
    /// Create a QR code which contains specified data using a specified encoding method.
    ...
    public QRCode(string dataToEncode, EncodingMode encodingMode) {
        QRCode(dataToEncode, encodingMode, ErrorCorrectionLevel.MEDIUM);
    }
